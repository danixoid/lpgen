...
{{--            document.domain = '{!! preg_replace('/^https?:\/\//','',request()->root()) !!}';--}}
            ...
            $('#iblock').css('width',$('.container').width()/scale);
            ...
            $('#iblock').css('height',$('#frameHeight').val()/scale);

            $('#frameHeight').on('change',function(){
                $('#iblock').css('height',$(this).val()/scale);
            });
        });
    </script>
@endsection
...
@section('content')
    <section class="p-y-lg">
        ...
        <div class="container">
            ...
            <form class="form form-horizontal" action="{!! route('block.store') !!}" method="post">
                {!! csrf_field() !!}
                {{--@csrf--}}
                ...
                <div class="form-group">
                    <div class="col-md-4">
                        ...
                        <input type="text" pattern="[\w\-]+" class="form-control" placeholder="Имя лат." name="name" required/>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="frameHeight" class="form-control" placeholder="Высота" name="height" value="700" required/>
                    </div>
                </div><!-- /End Row -->
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane active" id="view" role="tabpanel" aria-labelledby="view-tab">
                        ...
                        <iframe id="iblock" src="{!! route('builder.skeleton') !!}"></iframe>
