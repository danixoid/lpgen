            ...
            <ul id="pages">
                <li style="display: none;" id="newPageLI">
                  ...
                  <span class="pageButtons">
                      ...
                      <a href="#" class="btn btn-xs btn-primary btn-embossed fileSave"><span class="fui-check"></span></a>
                  </span>
                </li>
                <li class="active">
              ...
              <div class="sideButtons clearfix">
                  ...
                  <!-- <a href="#metaModal" data-toggle="modal" class="btn btn-info btn-sm btn-embossed disabled actionButtons"><span class="fui-export"></span> Опубликовать</a> -->
              </div>
        {{--<hr>
            ...
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="#"  id="preview" class="btn-embossed disabled actionButtons"><span class="fui-window"></span> Предпросмотр</a></li>
